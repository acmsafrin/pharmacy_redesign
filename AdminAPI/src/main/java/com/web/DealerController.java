...
//url:http://localhost:8080/StudentRestApiHibernateSpring/dealer/
public class DealerController<S extends DealerService> {
    ...
    public @ResponseBody
    String save(@RequestBody Dealer entity) {
        String result;
        try {
            service.save(entity);
    ...
    public @ResponseBody
    String update(@PathVariable("id") long id, @RequestBody Dealer entity) {
        String result;
        try {
