...
import com.service.ItemDistributorService;
 ...
 */
@RestController
@RequestMapping("/itemDistributor")
//url:http://localhost:8080/StudentRestApiHibernateSpring/itemDistributor/
public class ItemDistributorController<S extends ItemDistributorService> {
    ...
    public @ResponseBody
    String save(@RequestBody ItemsDistributors entity) {
        String result;
        try {
            service.save(entity);
    ...
    public @ResponseBody
    String update(@PathVariable("id") long id, @RequestBody ItemsDistributors entity) {
        String result;
        try {
